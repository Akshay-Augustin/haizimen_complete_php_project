...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    foreach ($days as $day) {
        ...
        $stmt = $conn->prepare("
            INSERT INTO caretaker_availability (caretaker_user_id, day_name, is_available, start_time, end_time)
            VALUES (?, ?, ?, ?, ?)
...
$availabilityMap = [];
$stmt = $conn->prepare("SELECT * FROM caretaker_availability WHERE caretaker_user_id = ?");
...
<div class="wrap">
    <div class="card">
        <h1>Manage Caretaker Availability</h1>
